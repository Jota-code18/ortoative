  ...
  return (
    <div className="mx-auto max-w-5xl px-4 pb-20 pt-28">
      ...
      <p className="mt-4 max-w-2xl text-lg text-muted-foreground">
        Aprenda ortodontia com quem escreveu o livro — literalmente. Formação prática com
        o Prof. Dr. Rui Cambauva e a estrutura de quem fabrica o próprio alinhador.
      </p>
        ...
        <div className="rounded-xl border border-border/70 p-6 transition-colors hover:bg-realce">
          ...
          <ul className="mt-4 space-y-2 text-base text-muted-foreground">
            <li className="flex gap-2">
              ...
              <span>Autor de ORTODONTIA – Diagnóstico Clínico & Cefalométrico</span>
            </li>
            <li className="flex gap-2">
              <span aria-hidden="true">•</span>
              <span>Autor de Construindo VTO: guia passo-a-passo</span>
            </li>
            <li className="flex gap-2">
              <span aria-hidden="true">•</span>
              <span>Esp., Me. e Dr. em Ortodontia; Esp. e Me. em Radiologia</span>
            </li>
            <li className="flex gap-2">
              <span aria-hidden="true">•</span>
              <span>Ex-professor: UNAERP, UNIFEB, SLMANDIC e FUNORTE</span>
            </li>
          </ul>
        </div>
        <PhotoPlaceholder
