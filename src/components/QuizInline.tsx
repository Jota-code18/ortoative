      ...
      {concluido ? (
        <div className="text-center">
          ...
          <a
            ...
            className="mt-5 inline-block rounded-full bg-brand-green-btn px-8 py-4 text-lg font-extrabold text-white transition-transform hover:scale-105"
          >
            Agendar agora
          </a>
          <button
            ...
            <>
              ...
              >
                ...
                <button
                  ...
                  className="mt-3 w-full rounded-full bg-brand-green-btn px-6 py-3 font-bold text-white transition-transform hover:scale-105 disabled:cursor-not-allowed disabled:opacity-40 disabled:hover:scale-100"
                >
                  Concluir
                </button>
              </form>
              ...
              <div className="mt-5 flex flex-wrap justify-center gap-2">
                {etapa.opcoes.map((opcao) => (
                  <button
                    ...
                    className="flex min-h-[44px] items-center rounded-full border border-white/25 bg-white/5 px-4 text-sm font-semibold text-white transition-colors hover:border-brand-green hover:bg-brand-green-btn"
                  >
                    {opcao.label}
                  </button>
                ))}
